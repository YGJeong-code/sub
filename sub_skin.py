...
myPath = 'C:/Users/ygjeong/Desktop/ygjeong/202210/rig/sub/'
...
def sub_body_Grp_matrix():
    myMeshShape = cmds.listRelatives('sub_body_Grp', c=True, ad=True, type='geometryShape')
    myMesh = cmds.listRelatives(myMeshShape, p=True)
    for i in myMesh:
        cmds.connectAttr ('FKRoot_M.matrix', i+'.offsetParentMatrix', f=True)
sub_body_Grp_matrix()
